...
<?php if ($imageId && get_post($imageId)) : ?>
    ...
    if (! empty($thumbnail_html)) :
        ...
        <p class="hide-if-no-js">
            <a href="javascript:;" id="remove_listing_image_button">
                <?php esc_html__('Remove image', YS_GROUPS_TEXT_DOMAIN) ?>
            </a>
        </p>
    ...
    <p class="hide-if-no-js">
        <a
            title="<?= esc_attr__('set listing image', YS_GROUPS_TEXT_DOMAIN) ?>"
            href="javascript:;"
            id="upload_listing_image_button"
            data-uploader_title="<?= esc_attr__('Choose an image', YS_GROUPS_TEXT_DOMAIN) ?>"
            data-uploader_button_text="<?= esc_attr__('Set listing image', YS_GROUPS_TEXT_DOMAIN) ?>"
        >
            <?php echo esc_html__('Set listing image', YS_GROUPS_TEXT_DOMAIN) ?>
        </a>
    </p>
